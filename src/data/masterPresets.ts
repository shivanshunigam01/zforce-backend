...
export const MASTER_PRESETS: MasterPresetRow[] = [
  ...
  // Vehicle models
  {
    ...
    name: "ZForce Elite",
    code: "MDL-ELITE",
    extra: { category: "Passenger", basePrice: "185000" },
  },
  {
    type: "models",
    name: "ZForce Plus",
    code: "MDL-PLUS",
    extra: { category: "Passenger", basePrice: "165000" },
  },
  {
    type: "models",
    name: "ZForce Cargo",
    code: "MDL-CARGO",
    extra: { category: "Commercial", basePrice: "195000" },
  },
  {
    type: "models",
    name: "ZForce City",
    code: "MDL-CITY",
    extra: { category: "Passenger", basePrice: "145000" },
  },
